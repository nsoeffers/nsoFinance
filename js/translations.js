define('translations', [], function() {
    ...
    translations['en-us'] = {        
        ...
        "mapConceptsOntoData"           : "Identify columns by dragging the labels to the correct column, some columns may already been mapped by the automap function but is always good habit to verify them.",
    ...
    translations['nl-be'] = {
        ...
        "mapConceptsOntoData"           : "Identificeer de kolommen door de labels naar de correcte kolom te slepen, sommige kolommen kunnen al gelinkt zijn door onze automap functionaliteit maar het is een goede gewoonte om deze nog even na te kijken",
        "processFile"                   : "Proficiat, alle verplichte labels zijn gelinkt. Druk op de knop om alle verrichtingen te importeren of ga nog even verder om ook de optionele velden te linken",
